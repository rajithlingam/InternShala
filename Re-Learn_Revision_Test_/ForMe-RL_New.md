# 📅 ForMe-RL: 6-Week Frontend + DSA Interview Prep Plan
...
➡️ Task: Rebuild a landing page in **TailwindCSS**
...
➡️ Task: Build `User` model with validation (name, email, password length > 6)
...
## W-5 (06:30PM – 08:30PM) → Backend (JWT + Project)
