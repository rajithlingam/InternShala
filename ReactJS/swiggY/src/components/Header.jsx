...
function Header() {
  return (
    <nav className="dark:bg-gray-900 bg-gray-900 text-white text-lg flex justify-between px-10 items-center h-10">
      <svg class="VXJlj" viewBox="0 0 61 61" height="29" width="49">
        <g clip-path="url(#a)">
          <path
            fill="#FF5200"
